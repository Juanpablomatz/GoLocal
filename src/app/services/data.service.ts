  ...
  private content: any = {
    es: {
      ...
      taquerias: {
        ...
        text: "Calvillo y sus alrededores cuentan con opciones de taquerías donde encontrarás tacos al pastor, de barbacoa y guisados caseros. Recomendamos preguntar por los ingredientes locales y horarios.",
        extra: "Consejo: prueba los tacos con salsas locales y acompáñalos con aguas frescas.",
